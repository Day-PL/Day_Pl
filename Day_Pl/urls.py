...
urlpatterns = [
    ...
    path("new-plan/get-filter/<int:placetype_id>/<str:search_keyword>/", new_plan.get_filter, name='get_filter'),
    path("new-plan/comment/", new_plan.create_comment, name='create-place-comment'),
